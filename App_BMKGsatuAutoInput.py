...
class Application(tk.Tk):
    ...
    def run_auto_input(self):
        try:
            ...
            # Jalankan Playwright dan proses pengisian form
            with sync_playwright() as playwright:
                # Inisialisasi BrowserLoader
                loader = BrowserLoader(
                    playwright=playwright,
                    user_data_dir='/Users/mb2/learn-python/autoss/.venv/bin/python /Users/mb2/learn-python/auto-input-BMKGSatu/',  # Direktori penyimpanan data login
                    headless=False
                )
